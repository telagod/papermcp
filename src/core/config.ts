...
const configSchema = z.object({
  ...
  httpTimeoutMs: z.coerce.number().int().positive().default(20000),
  httpRetryCount: z.coerce.number().int().nonnegative().default(3),
  httpMaxConcurrent: z.coerce.number().int().positive().default(4),
  httpMinIntervalMs: z.coerce.number().int().nonnegative().default(100),
